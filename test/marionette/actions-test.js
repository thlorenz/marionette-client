...
suite('marionette/actions', function () {
  var driver, subject, client, device, Actions, Client
  ...
  suite('.tap', function () {
    ...
    test('should have a tap action in the chain', function () {
      var tapAction = [['press', element.id, x, y], ['release']]
  ...
  suite('.flick', function () {
    ...
    test(
      'should have a flick action in the chain ' +
        'when the duration param is 300',
      function () {
        var duration = 300
  ...
  suite('.longPress', function () {
    ...
    test('should have a long press action in the chain', function () {
      var longPressAction = [['press', element.id], ['wait', time], ['release']]
